...
if(isset($_GET['UsernameID'])){
    ...
    $sql = "UPDATE booking SET status='CONFIRMED' WHERE booking_id ='$booking_id'";
    array_push($okay, "Confirmed Successfully!");
    echo "<meta http-equiv='refresh' content='0;url=pendingbookings.php'>";
    mysqli_query($db, $sql); 
...
<div id="content_center"><!--/this is the Content center/-->
   ...
   echo  "<div class='note_empty'>No reservation</div>";
        ...
        echo"<fieldset id='fieldset'>";
             ...
             <a href="pendingbookings.php?UsernameID=<?php echo $updates['booking_id']; ?>" class="call_modal_edit" onclick="return confirm('ARE YOU SURE IF YOU WANT TO CONFIRMED THIS?');">CONFIRMED</a>
