...
$sql = "select * from booking inner join updates_place inner join updates ON updates_place.place_name = booking.destination AND updates.vehicle_name=booking.vehicle and username='".$_SESSION['username']."' WHERE status='CONFIRMED' ORDER BY booking_id DESC";
    ...
    while($updates= mysqli_fetch_array($records)){
        echo"<fieldset id='fieldset'>";
            ...
            <?php
                ...
                echo "<img src='admin/images/".$updates['image']."'>";
