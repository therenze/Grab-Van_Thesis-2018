...
$sql = "select * from updates inner join updates_place inner join booking inner join gav_user ON updates_place.place_name = booking.destination AND updates.vehicle_name=booking.vehicle and gav_user.username=booking.username WHERE status='CANCELED'";
...
if(isset($_GET['booking_id'])){
    ...
    array_push($okay, "booking Is DELETED Successfully!");
    echo "<meta http-equiv='refresh' content='0;url=canceledbookings.php'>";
    mysqli_query($db, $sql); 
...
<div id="content_center"><!--/this is the Content center/-->
   ...
   echo  "<div class='note_empty'>No reservation</div>";
        ...
        echo"<fieldset id='fieldset'>";
              ...
              <a href="canceledbookings.php?booking_id=<?php echo $updates['booking_id']; ?>" class="call_modal_delete" onclick="return confirm('ARE YOU SURE IF YOU WANT TO DELETE THIS?'); ">DELETE</a>
